...
- **Hear it:** open `https://radio.hetti.be/norns.mp3` in any browser tab / media
  player (VLC: *Open Network Stream*) — works anywhere (the box's icecast,
  fronted by its own hostname). Same-origin alias: `https://dspm.hetti.be/radio.mp3`.
